...
{
    public class LaserBase : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            // We start drawing the laser if we have charged up
                DrawLaser(Main.spriteBatch, TextureAssets.Projectile[ModContent.ProjectileType<LaserBase>()].Value, Main.player[Projectile.owner].Center,
