namespace ProjectInfinity.Core
{
	...
	{
		public const string Assets = "ProjectInfinity/Assets/";
		...
		public const string Ranged = Items + "Ranged/";
		public const string Summoner = Items + "Summoner/";
		public const string SummonsBoss = Items + "SummonsBoss/";
		...
		//Parkour
		public const string Parkour = Assets + "Parkour/";
		public const string Parkour_CrystalDesert = Parkour + "CrystalDesert/";
